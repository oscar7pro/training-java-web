...
<head>
  ...
  <link rel="preload" href="https://lh5.googleusercontent.com/proxy/xvtq6_782kBajCBr0GISHpujOb51XLKUeEOJ2lLPKh12-xNBTCtsoHT14NQcaH9l4JhatcXEMBkqgUeCWhb3XhdLnD1BiNzQ_LVydwg=w3840-h2160-p-k-no-nd-mv" as="image">
  <meta http-equiv="Content-Security-Policy"
      content="object-src 'none';child-src chrome-search://most-visited/ https://*.google.com/ ;script-src 'strict-dynamic' 'sha256-1+GSDjMMklBjZY0QiWq+tGupCvajw4Xbn46ect2mZgM=' 'sha256-2mX1M62Fd0u8q0dQY2mRsK5S1NS9jJuQAvyE8tD0dkQ=' 'sha256-EtIKSV82ixJHE3AzqhoiVbUGKG+Kd8XS0fFToow29o0=' 'sha256-QSyFltV9X3gkyBrg+SMfKvZNXmqPQc6K4B6OYhTuXmw=' 'sha256-ANdtIo91Yk/zh1YKZ+IXKP1pb00awOjEFMAUld02F6A=' 'sha256-CbH+xPsBKQxVw5d9blISLDeuMSe1M+dJ4xfArFynIfw=' 'sha256-lA+EURA/fC0TZq1ATYZvxIQHBc9iTAaBcI+dFMmTn9I=' 'sha256-r8M35L32RquDK8jFp/tROc74JLQUl2lsS/eNENiX+gw=';">
...
<body>
  ...
  <div id="ntp-contents">
    ...
    <div id="edit-bg" tabindex="0" role="button" hidden>
      ...
      <span id="edit-bg-text">Personnaliser</span>
    </div>
  ...
  <dialog id="customization-menu" class="customize-dialog">
    <div id="menu-nav-panel" role="tablist" aria-label="Personnaliser cette page">
      ...
      <button id="colors-button" class="menu-option" tabindex="0" role="tab"
          ...
          aria-labelledby="colors-menu-option" title="Couleur et thème">
        <div class="menu-option-icon-wrapper">
    ...
    <div id="menu-contents">
      <div id="menu-header">
        ...
        <div id="menu-title">Personnaliser cette page</div>
        <div id="refresh-daily-wrapper">
          <div id="refresh-toggle-wrapper" title="Actualiser quotidiennement">
            <label class="switch">
          ...
          <div id="refresh-text">Actualiser quotidiennement</div>
        </div>
      </div>
      <div id="backgrounds-menu" class="menu-panel" tabindex="0"
          role="tabpanel" aria-label="Arrière-plan">
        <div id="backgrounds-upload" class="bg-sel-tile-bg">
          <div id="backgrounds-upload-icon" class="bg-sel-tile" tabindex="-1"
              role="button" aria-label="Importer depuis l&#39;appareil"
              aria-pressed="false" title="Importer depuis l&#39;appareil">
            <div id="backgrounds-upload-arrow"></div>
            <div id="backgrounds-upload-text">Importer depuis l&#39;appareil</div>
          </div>
        </div>
        <div id="backgrounds-default" class="bg-sel-tile-bg">
          <div id="backgrounds-default-icon" class="bg-sel-tile" tabindex="-1"
              role="button" aria-label="Sans arrière-plan"
              title="Sans arrière-plan" aria-pressed="false">
            <div class="mini-page">
              <div class="mini-header-colorful"></div>
              <div class="mini-shortcuts"></div>
            </div>
          </div>
          <div class="bg-sel-tile-title">Sans arrière-plan</div>
        </div>
      </div>
      <div id="backgrounds-image-menu" class="menu-panel" tabindex="0"
          role="tabpanel" aria-label="Arrière-plan"></div>
      <div id="backgrounds-disabled-menu" class="menu-panel" tabindex="0"
        ...
        <div id="backgrounds-disabled-wrapper">
          ...
          <div id="backgrounds-disabled-title">
            Votre administrateur a désactivé les arrière-plans personnalisés
          </div>
        </div>
      </div>
        ...
        <div id="sh-options">
          <div class="sh-option">
            <div id="sh-option-cl" class="sh-option-image" tabindex="-1"
                ...
                aria-labelledby="sh-option-cl-title" title="Mes raccourcis">
            ...
            Les raccourcis affichés sont ceux que vous avez vous-même définis
          </div>
          <div class="sh-option">
            <div id="sh-option-mv" class="sh-option-image" tabindex="-1"
                role="button" aria-pressed="false"
                aria-labelledby="sh-option-mv-title" title="Sites les plus consultés">
              <div class="sh-option-icon"></div>
              <div class="sh-option-mini">
                <div class="mini-page">
                  <div class="mini-header"></div>
            ...
            Les raccourcis affichés sont des suggestions fondées sur les sites Web que vous consultez souvent
          </div>
        </div>
        <div id="sh-hide">
          <div id="sh-hide-icon"></div>
          <div>
            <div id="sh-hide-title">Masquer les raccourcis</div>
            Ne pas afficher de raccourcis sur cette page
          </div>
          <div id="sh-hide-toggle-wrapper" title="Masquer les raccourcis">
            <label class="switch">
      ...
      <div id="colors-menu" class="menu-panel" tabindex="0" role="tabpanel"
        ...
        <div id="color-picker-container" class="bg-sel-tile-bg">
          <div id="color-picker-tile" class="bg-sel-tile" tabindex="-1"
            aria-label="Sélectionner couleur"
            title="Sélectionner couleur"
            role="button" aria-pressed="false">
